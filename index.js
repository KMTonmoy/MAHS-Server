...
async function run() {
  try {
    ...
    const bannerCollection = client.db("MAHS").collection("BannerCollection");
    const usersCollection = client.db("MAHS").collection("users");
    const blogCollection = client.db("MAHS").collection("blogCollection");
